...
public class ForgePlatformHelper implements IPlatformHelper {
    ...
    @Override
    public void sendToTracking(Player tracked, S2CModPacket packet) {
        PacketHandlerForge.INSTANCE.send(PacketDistributor.TRACKING_ENTITY_AND_SELF.with(() -> tracked),packet);
    }
}